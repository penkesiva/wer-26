...
flowchart LR
    ...
    subgraph Mobile["<b><span style='font-size:22px'>Mobile phone</span></b>"]
        ...
        subgraph SSGC["<b><span style='font-size:18px'>SS-Glasses-Core</span></b>"]
            ...
            OrchCP["<b>EventOrchestrator:Park</b><br/>Cue · capture · on-device LLM · save"]
        end
        VLM["<b>On-device LLM</b><br/>Scene + OCR (VLM)"]
    ...
    subgraph Legend["Legend"]
        ...
        LgL["<b>On-device LLM</b><br/>Vision / language on phone"]
    ...
    classDef onDeviceLlm fill:#c8e6c9,stroke:#2e7d32,color:#111,stroke-width:2px
