...
```mermaid
%%{init: {'flowchart': {'htmlLabels': true, 'padding': 6, 'nodeSpacing': 18, 'rankSpacing': 36}}}%%
%% Idea 2 — Mark Car Parking Spot · mermaid.live
%% flowchart TB: Mobile (top) → Glasses (bottom) → Legend
%% Reverse edges Glasses→Mobile are dashed to keep TB rank intact
